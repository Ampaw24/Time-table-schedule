...
?>
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="departmentform.php">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              <h2 class="ml-4">Department View</h2>
    ...
    ?>
     ...
     <td>
     <a href="delete_department.php?id=<?php echo $row['id'];?>"><button class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</button></a> 
