...
?>
  ...
  <body>
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="staffform.php">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Add Staff</p>
                    </div>
                  </a>
    ...
    ?>
     ...
     <td><?php echo $row['staff_mail']?></td>
     <td><?php echo $row['faculty']?></td>
     <td>
     <a href="staff_delete.php?id=<?php echo $row['id'];?>"><button class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</button></a> 
